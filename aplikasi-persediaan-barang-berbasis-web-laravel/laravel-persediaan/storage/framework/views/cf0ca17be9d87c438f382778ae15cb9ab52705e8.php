...
<script>
    ...
    function getData() {
        ...
        table = $('#table-1').DataTable({
            ...
            "ajax": {
                "url": "<?php echo e(route('lap-bk.getlap-bk')); ?>",
                "data": function(d) {
    ...
    function print() {
        ...
        if (tglawal != '' && tglakhir != '') {
            window.open(
                "<?php echo e(route('lap-bk.print')); ?>?tglawal=" + tglawal + "&tglakhir=" + tglakhir,
                '_blank'
            );
        } else {
            swal({
    ...
    function pdf() {
        ...
        if (tglawal != '' && tglakhir != '') {
            window.open(
                "<?php echo e(route('lap-bk.pdf')); ?>?tglawal=" + tglawal + "&tglakhir=" + tglakhir,
                '_blank'
            );
        } else {
            swal({
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Master.Layouts.app', ['title' => $title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Admin/Laporan/BarangKeluar/index.blade.php ENDPATH**/ ?>