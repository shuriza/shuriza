                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="customerU" id="customerU" class="form-control">
                                ...
                                <option value="<?php echo e($c->customer_id); ?>"><?php echo e($c->customer_nama); ?></option>
...
<script>
    ...
    function getbarangbyidU(id) {
        ...
        $.ajax({
            type: 'GET',
            url: "<?php echo e(url('admin/barang/getbarang')); ?>/" + id,
            processData: false,
            contentType: false,
            dataType: 'json',
    ...
    function submitFormU() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('admin/barang-masuk/proses_ubah')); ?>/" + id,
...
<?php $__env->stopSection(); ?><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Admin/BarangMasuk/edit.blade.php ENDPATH**/ ?>