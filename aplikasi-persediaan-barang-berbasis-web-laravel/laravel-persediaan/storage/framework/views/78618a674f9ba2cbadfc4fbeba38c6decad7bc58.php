...
<div class="modal fade" data-bs-backdrop="static" id="modaldemo8">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form method="POST" action="<?php echo e(route('user.store')); ?>" name="myForm" enctype="multipart/form-data" onsubmit="return validateForm()">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <select name="role" class="form-control">
                                    ...
                                    <option value="<?php echo e($r->role_id); ?>"><?php echo e($r->role_title); ?></option>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <center>
                                    <img src="<?php echo e(url('/assets/default/users/undraw_profile.svg')); ?>" width="80%" alt="profile-user" id="outputImg" class="brround">
                                </center>
...
<script>
    ...
    function reset() {
        ...
        $("input[name='pwd']").val('');
        $("input[name='pwdU']").val('');
        $("#outputImg").attr("src", "<?php echo e(url('/assets/default/users/undraw_profile.svg')); ?>");
        $("#GetFile").val('');
    }
...
</script><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Master/User/tambah.blade.php ENDPATH**/ ?>