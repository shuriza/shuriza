...
<div class="modal fade" data-bs-backdrop="static" id="Hmodaldemo8">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <form method="POST" action="<?php echo e(url('/admin/user/hapus')); ?>" name="myFormH" id="myFormH" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Master/User/hapus.blade.php ENDPATH**/ ?>