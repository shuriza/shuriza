...
<head>
    ...
    <link id="theme" rel="stylesheet" type="text/css" media="all"
        href="<?php echo e(url('/assets/colors/color1.css')); ?>" />
    <style>
        modal.fade {
...
<?php if($appreance != ''): ?>
    ...
    <body
        class="app ltr <?php echo e($appreance->appreance_layout); ?> <?php echo e($appreance->appreance_theme); ?> <?php echo e($appreance->appreance_menu); ?> <?php echo e($appreance->appreance_header); ?> <?php echo e($appreance->appreance_sidestyle); ?>">
    <?php else: ?>
...
<!-- GLOBAL-LOADER -->
<?php if($appreance != ''): ?>
    <div id="global-loader" class="<?php echo e($appreance->appreance_theme == 'dark-mode' ? 'bg-dark' : ''); ?>">
    <?php else: ?>
...
<div class="page">
    <div class="page-main">
        ...
        <!-- APP HEADER -->
        <?php echo $__env->make('Master.Layouts.header', ['web' => $web], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- END APP HEADER -->

        <!-- SIDEBAR -->
        <?php echo $__env->make('Master.Layouts.sidebar-left', ['web' => $web], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- END SIDEBAR -->
    ...
    <!-- FOOTER -->
    <?php echo $__env->make('Master.Layouts.footer', ['web' => $web], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- FOOTER END -->
...
<div class="modal fade" data-bs-backdrop="static" id="modalLogout">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <form method="GET" action="<?php echo e(url('admin/logout')); ?>" name="myFormH" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<!-- INPUT MASK JS-->
<script src="<?php echo e(url('/assets/plugins/input-mask/jquery.mask.min.js')); ?>"></script>
...
<script src="<?php echo e(url('/assets/plugins/bootstrap-daterangepicker/moment.min.js')); ?>"></script>
<script src="<?php echo e(url('/assets/plugins/bootstrap-daterangepicker/daterangepicker.js')); ?>"></script>

<!-- INTERNAL Bootstrap-Datepicker js-->
<script src="<?php echo e(url('/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.js')); ?>"></script>
...
<script src="<?php echo e(url('/assets/plugins/intl-tel-input-master/intlTelInput.js')); ?>"></script>
<script src="<?php echo e(url('/assets/plugins/intl-tel-input-master/country-select.js')); ?>"></script>
<script src="<?php echo e(url('/assets/plugins/intl-tel-input-master/utils.js')); ?>"></script>
...
<!-- COLOR PICKER JS -->
<script src="<?php echo e(url('/assets/plugins/pickr-master/pickr.es5.min.js')); ?>"></script>
<script src="<?php echo e(url('/assets/js/picker.js')); ?>"></script>
...
<script src="<?php echo e(url('/assets/plugins/chart/rounded-barchart.js')); ?>"></script>
...
<script src="<?php echo e(url('/assets/plugins/datatable/js/buttons.bootstrap5.min.js')); ?>"></script>
<script src="<?php echo e(url('/assets/plugins/datatable/js/jszip.min.js')); ?>"></script>
<script src="<?php echo e(url('/assets/plugins/datatable/pdfmake/pdfmake.min.js')); ?>"></script>
<script src="<?php echo e(url('/assets/plugins/datatable/pdfmake/vfs_fonts.js')); ?>"></script>
...
<script src="<?php echo e(url('/assets/plugins/datatable/responsive.bootstrap5.min.js')); ?>"></script>
...
<?php echo $__env->yieldContent('formTambahJS'); ?>
<?php echo $__env->yieldContent('formEditJS'); ?>
<?php echo $__env->yieldContent('formHapusJS'); ?>
<?php echo $__env->yieldContent('formOtherJS'); ?>

</body>

</html>
<?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Master/Layouts/app.blade.php ENDPATH**/ ?>