...
<head>
    ...
    <!-- TITLE -->
    <title>Halaman tidak ditemukan | <?php echo e($web->web_nama); ?></title>
                ...
                <div class="container text-center">
                    <div class="error-template">
                        ...
                        <div class="text-center">
                            <a class="btn btn-primary mt-5 mb-5" href="<?php echo e(url('/admin')); ?>"> <i class="fa fa-long-arrow-left"></i> Kembali </a>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\shuriza\aplikasi-persediaan-barang-berbasis-web-laravel\laravel-persediaan\resources\views/errors/404.blade.php ENDPATH**/ ?>