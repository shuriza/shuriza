...
<div class="app-header header sticky">
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal" href="<?php echo e(url('/')); ?>">
                        ...
                        <div class="d-flex justify-content-between order-lg-2">
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                    <div class="text-end">
                                        <h5 class="text-dark mb-0 me-4 fs-14 fw-semibold"><?php echo e(Session::get('user')->user_nmlengkap); ?></h5>
                                        <small class="text-muted me-4"><?php echo e(Session::get('user')->role_title); ?></small>
                                    </div>
                                    <?php if(Session::get('user')->user_foto == 'undraw_profile.svg'): ?>
                                    <img src="<?php echo e(url('/assets/default/users/undraw_profile.svg')); ?>" alt="profile-user" class="avatar  profile-user brround cover-image">
                                    <?php else: ?>
                                    <img class="avatar profile-user brround cover-image" src="<?php echo e(asset('storage/users/'.Session::get('user')->user_foto)); ?>" alt="avatar">
                                    <?php endif; ?>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <!-- <div class="drop-heading">
                                        <div class="text-center">
                                            <h5 class="text-dark mb-0 fs-14 fw-semibold"><?php echo e(Session::get('user')->user_nmlengkap); ?></h5>
                                            <small class="text-muted"><?php echo e(Session::get('user')->role_title); ?></small>
                                        </div>
                                    </div> -->
                                    <!-- <div class="dropdown-divider m-0"></div> -->
                                    <a class="dropdown-item" href="<?php echo e(url('/admin/profile')); ?>/<?php echo e(Session::get('user')->user_id); ?>">
                                        <i class="dropdown-icon fe fe-user"></i> Profile
                                    </a>
                                    <a class="dropdown-item" href="<?php echo e(url('/admin/appreance')); ?>">
...
<!-- /app-Header --><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Master/Layouts/header.blade.php ENDPATH**/ ?>