                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenisbarangU" class="form-control">
                                ...
                                <?php $__currentLoopData = $jenisbarang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($jb->jenisbarang_id); ?>"><?php echo e($jb->jenisbarang_nama); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="satuanU" class="form-control">
                                ...
                                <option value="<?php echo e($s->satuan_id); ?>"><?php echo e($s->satuan_nama); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="merkU" class="form-control">
                                ...
                                <option value="<?php echo e($m->merk_id); ?>"><?php echo e($m->merk_nama); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <center>
                                <img src="<?php echo e(url('/assets/default/barang/image.png')); ?>" width="80%" alt="profile-user" id="outputImgU" class="">
                            </center>
...
<?php $__env->startSection('formEditJS'); ?>
<script>
    function checkFormU() {
    ...
    function submitFormU() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('admin/barang/proses_ubah')); ?>/" + id,
            processData: false,
            contentType: false,
            dataType: 'json',
            data: fd,
    ...
    function resetU() {
        ...
        $("#outputImgU").attr("src", "<?php echo e(url('/assets/default/barang/image.png')); ?>");
        $("#GetFileU").val('');
        setLoadingU(false);
    }
...
<?php $__env->stopSection(); ?><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Admin/Barang/edit.blade.php ENDPATH**/ ?>