...
<body onload="window.print()">
    ...
    <center>
        <?php if($web->web_logo == '' || $web->web_logo == 'default.png'): ?>
        <img src="<?php echo e(url('/assets/default/web/default.png')); ?>" width="80px" alt="">
        <?php else: ?>
        <img src="<?php echo e(url('/assets/default/web/default.png')); ?>" width="80px" alt="">
        <?php endif; ?>
    </center>
...
</html><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Admin/Laporan/BarangMasuk/print.blade.php ENDPATH**/ ?>