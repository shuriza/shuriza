...
<?php $__env->startSection('formHapusJS'); ?>
<script>
    function submitFormH() {
        setLoadingH(true);
        const id = $("input[name='idjenisbarang']").val();

        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('admin/jenisbarang/proses_hapus')); ?>/" + id,
...
<?php $__env->stopSection(); ?><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Admin/JenisBarang/hapus.blade.php ENDPATH**/ ?>