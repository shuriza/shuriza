                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <center>
                                <img src="<?php echo e(url('/assets/default/barang/image.png')); ?>" width="80%" alt="profile-user" id="outputImg" class="">
                            </center>
...
<?php $__env->startSection('formTambahJS'); ?>
<script>
    function checkForm() {
    ...
    function reset() {
        ...
        $("#outputImg").attr("src", "<?php echo e(url('/assets/default/barang/image.png')); ?>");
        $("#GetFile").val('');
        setLoading(false);
    }
...
<?php $__env->stopSection(); ?><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Admin/Barang/tambah.blade.php ENDPATH**/ ?>