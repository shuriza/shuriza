...
<script>
    ...
    function getData() {
        ...
        table = $('#table-1').DataTable({
            ...
            "ajax": {
                "url": "<?php echo e(route('lap-bm.getlap-bm')); ?>",
                "data": function(d) {
    ...
    function print() {
        ...
        if (tglawal != '' && tglakhir != '') {
            window.open(
                "<?php echo e(route('lap-bm.print')); ?>?tglawal=" + tglawal + "&tglakhir=" + tglakhir,
                '_blank'
            );
        } else {
            swal({
    ...
    function pdf() {
        ...
        if (tglawal != '' && tglakhir != '') {
            window.open(
                "<?php echo e(route('lap-bm.pdf')); ?>?tglawal=" + tglawal + "&tglakhir=" + tglakhir,
                '_blank'
            );
        } else {
            swal({
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Master.Layouts.app', ['title' => $title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Admin/Laporan/BarangMasuk/index.blade.php ENDPATH**/ ?>