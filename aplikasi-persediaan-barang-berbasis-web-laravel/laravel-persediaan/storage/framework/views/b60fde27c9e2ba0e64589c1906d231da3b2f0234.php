...
<script>
    ...
    function getData() {
        ...
        table = $('#table-1').DataTable({
            ...
            "ajax": {
                "url": "<?php echo e(route('lap-sb.getlap-sb')); ?>",
                "data": function(d) {
    ...
    function print() {
        ...
        var tglakhir = $('input[name="tglakhir"]').val();
        window.open(
            "<?php echo e(route('lap-sb.print')); ?>?tglawal=" + tglawal + "&tglakhir=" + tglakhir,
            '_blank'
        );
    ...
    function pdf() {
        ...
        var tglakhir = $('input[name="tglakhir"]').val();
        window.open(
            "<?php echo e(route('lap-sb.pdf')); ?>?tglawal=" + tglawal + "&tglakhir=" + tglakhir,
            '_blank'
        );
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Master.Layouts.app', ['title' => $title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Admin/Laporan/StokBarang/index.blade.php ENDPATH**/ ?>