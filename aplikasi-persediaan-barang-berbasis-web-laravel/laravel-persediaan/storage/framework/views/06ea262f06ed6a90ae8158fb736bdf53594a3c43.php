                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <center>
                                    <img src="<?php echo e(url('/assets/default/users/undraw_profile.svg')); ?>" width="80%" alt="profile-user" id="outputImgU" class="brround">
                                </center>
...
<script>
    ...
    function resetU() {
        ...
        $("#outputImgU").attr("src", "<?php echo e(url('/assets/default/users/undraw_profile.svg')); ?>");
        $("#GetFileU").val('');
    }
...
</script><?php /**PATH /Users/willyap/Sites/wordpress/Sistem-Persediaan-Laravel/resources/views/Master/User/ubah.blade.php ENDPATH**/ ?>