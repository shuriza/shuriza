...
Dokumen dalam `docs/` adalah ide/rencana, bukan daftar fitur yang seluruhnya tersedia. Binary Windows x64 sudah berhasil dibangun, dan pada paket lokal sudah diuji: ambil–panggil–panggil ulang–lewati–kembalikan–selesai, halaman riwayat/jejak audit, serta ketahanan data melewati restart aplikasi. Secure app bundle, install/upgrade lewat installer dengan database pengguna terisi, video demo, printer fisik, dan server pusat tetap harus diverifikasi sebelum proyek disebut siap rilis.
